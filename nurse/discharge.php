                    ...
                    <div class="col-lg-6 px-4 pb-4" id="order">
                        <form action="checkout.php" method="post" id="placeOrder">
                            ...
                            <div class="text-center">
                                ...
                                <h6 class="lead text-center">Patient Name: Qwerty</h6>
                                <h6 class="lead text-center">Email: qwerty@gmail.com</h6>
                                <h6 class="lead text-center">Address: 12345 St.</h6>
                                <h6 class="lead text-center">Mobile Number: 093255823852</h6>
                                <h6 class="lead text-center">Patient Status: Died</h6>
                                <h6 class="lead text-center">Room Number: 2000.00</h6>
                                <h6 class="lead text-center">Doctor Name: Dr. Qwerty</h6>
                                <h6 class="lead text-center">Doctor Prescribe Medicine: Paracetamol</h6>
                                <h6 class="lead text-center">Amount Input: 11,000.00</h6>
                                <h6 class="lead text-center">Total Amount: 10,000.00</h6>
                                <h6 class="lead text-center">Change: 1,000.00</h6>
                            </div>
