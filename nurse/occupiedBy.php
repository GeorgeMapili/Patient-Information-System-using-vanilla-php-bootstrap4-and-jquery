                        ...
                        <form action="checkout.php" method="post" id="placeOrder">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="address" value="Fever" class="form-control" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="">Doctor Prescription</label>
                                    <textarea type="text" name="mobilenumber" cols="30" rows="10" class="form-control" readonly>Paracetamol</textarea>
                                </div>
                            </div>
                        </form>
                    </div>
