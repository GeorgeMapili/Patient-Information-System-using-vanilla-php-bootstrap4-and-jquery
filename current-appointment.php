...
$_SESSION['log_current_appointment'] = true;
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <div class="btn-group dropbottom">
                        <a href="current-appointment.php" class="nav-link active">
                            Appointment
                        </a>
    ...
    <main role="main">
        ...
        <div class="container">
            ...
            <div class="mt-4 mb-4">
                <h1 class="Display-4" id="primaryColor">Appointments</h1>
            </div>
                    ...
                    <tbody>
                        <?php while ($appointment = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
                            <tr>
                                ...
                                <td>
                                    <form action="current-appointment.php" method="post">
