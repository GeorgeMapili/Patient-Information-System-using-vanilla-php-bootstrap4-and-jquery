...
$_SESSION['log_doctor_cancelled_appointment'] = true;
    ...
    <main role="main">
        ...
        <div class="container-fluid">
            ...
            <div class="mt-4 mb-4 d-flex justify-content-between">
                ...
                <p class="mt-5 text-white"><?= $cancelledCount ?> cancelled appointment</p>
            </div>
            ...
            ?>
            <p class="lead text-center text-white display-4">No cancelled appointment yet</p>
            <?php    
            }
            ?>
