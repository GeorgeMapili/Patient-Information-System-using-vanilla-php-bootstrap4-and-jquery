...
<body>
    ...
    if(isset($_POST['addTest'])){
        ...
        if($stmt->execute()){
            header("location:lab-patient-appointment.php?success=successfully_added_labtest");
            $_SESSION['log_doctor_lab_appointment_add_test'] = true;
            ob_end_flush();
            exit;
        }
    ...
    <main role="main">
        <div class="container-fluid">
            ...
            <div class="container">
                <form action="add-testlab-appointment.php" method="POST">
