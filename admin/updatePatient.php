        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    ...
                    <div class="mt-4 mb-4">
                        <h1 class="Display-4" id="primaryColor">Update Patient Information</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="gender" id="" class="form-control">
                                    ...
                                    <option value="male" selected>Dr. Qwerty</option>
                                    <option value="male">Dr. Qwerty</option>
                                    <option value="male">Dr. Qwerty</option>
                                    <option value="male">Dr. Qwerty</option>
                                    <option value="male">Dr. Qwerty</option>
                                </select>
                            ...
                            <div class="col">
                                ...
                                <select name="gender" id="" class="form-control">
                                    ...
                                    <option value="male">101</option>
                                    <option value="male">102</option>
                                    <option value="male">103</option>
                                    <option value="male" selected>104</option>
                                    <option value="male">105</option>
                                </select>
                            </div>
                        </div>

                        <label for="">Prescription or Medicines</label>
                        <textarea name="reasonAppointment" class="form-control resize-0" cols="10" rows="3">Paracetamol</textarea>
                        <div class="text-center mt-3">
                            <input type="submit" class="btn btn-primary" value="Update" name="submitAppointment">
                        </div>
                    </form>
                </div>
