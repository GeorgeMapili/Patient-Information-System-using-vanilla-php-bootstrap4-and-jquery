                ...
                <div class="container">
                    ...
                    <form action="contactus.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="exampleInputEmail1">Select a room</label>
                                <select name="gender" id="" class="form-control">
                                    <option value="">Select a room</option>
                                    <option value="male">101</option>
                                    <option value="male">102</option>
                                    <option value="male">103</option>
                                    <option value="male">104</option>
                                    <option value="male">105</option>
                                    <option value="male">106</option>
                                    <option value="male">107</option>
                                    <option value="male">108</option>
                                    <option value="male">109</option>
                                    <option value="male">110</option>
                                </select>
                            </div>
                        </div>
