                    ...
                    <form action="contactus.php" method="post">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="Qwert">
                            </div>
                            <div class="col">
                                <label for="exampleInputEmail1">Nurse Email</label>
                                <input type="text" class="form-control" value="qwert@gmail.com">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <label for="exampleInputEmail1">Nurse Address</label>
                                <input type="text" class="form-control" value="123445 St.">
                            </div>
                            <div class="col">
                                <label for="exampleInputEmail1">Nurse Mobile Number</label>
                                <input type="tel" class="form-control" value="09550292131">
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-3">
                            <input type="submit" class="btn btn-primary" value="Update Nurse" name="submitAppointment">
                        </div>
                    </form>
                </div>
