...
if (isset($_POST['receiptBtn'])) {
    ...
    $sql = "SELECT * FROM discharged_patient WHERE dpId = :dpId AND pId =:pId";
    $stmt = $con->prepare($sql);
    $stmt->bindParam(":dpId", $dpId, PDO::PARAM_INT);
    ...
    $pdf->Cell(130, 5, '', 0, 0);
    $pdf->Cell(34, 5, 'Discharge ID:', 0, 0);
    $pdf->Cell(25, 5, $medicalCertificate['dpId'], 0, 1);
    ...
    $date = date("M d, Y", strtotime($medicalCertificate['pMadeOn']));
