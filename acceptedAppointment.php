...
<head>
    ...
    <title>Patient | Accepted Appointment</title>
    <style>
        body{
...
<body>
    ...
    <main role="main">
        ...
        <div class="container">
            ...
            <div class="mt-4 mb-4">
                <h1 class="Display-4" id="primaryColor">Accepted appointments</h1>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <p class="btn btn-success disabled">Upcoming</p>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
            ...
            ?>
            <p class="lead text-center text-white display-4">No accepted appointments yet</p>
            <?php    
            }
            ?>
